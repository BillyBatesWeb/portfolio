$(document).ready(function() {
	...
	Backstretch Images
	==============================================*/
	$.backstretch('assets/troc.jpg');

	$('body').append('<img class="preload-image" src="assets/billybatesbw.jpg" style="display:none;"/>');
	...
	$('#about').waypoint(function(direction){
		...
		if (direction=='down'){
			$.backstretch('assets/billytroc.jpg');
		}else{
			$.backstretch('assets/troc.jpg');
		}
	});
	...
	$('#services').waypoint(function(direction){
		...
		if (direction=='down'){
			$.backstretch('assets/billybatesbw.jpg');
		}else{
			$.backstretch('assets/billytroc.jpg');
		}
	});
